...
const EarningRequirements: FC = () => {
    ...
    return (
        <div className="content-page">
                        ...
                        <div className="col-12">
                            <div className="page-title-box">
                                <div className="page-title-right">
                                    <Link to="/program/add-earning-requirements" className="btn btn-primary">Add Earning Requirement</Link>
                                </div>
                                <h4 className="page-title">Earning Requirement List</h4>
                            </div>
                        </div>
                    </div>
                    {/* end page title */}
                                ...
                                <div className="card-body">
                                    <table id="basic-datatable" className="table table-striped dt-responsive nowrap align-middle w-100">
                                        <thead>
                                            <tr>
                                                <th>Order</th>
                                                <th>Earning Requirement Name</th>
                                                ...
                                                <td>
                                                    <div className="dropdown">
                                                        ...
                                                        <div className="dropdown-menu dropdown-menu-animated">
                                                            <a href="#viewCompetencies" data-bs-toggle="modal" role="button" className="dropdown-item">View Competencies</a>
                                                            <a href="#viewPrograms" data-bs-toggle="modal" role="button" className="dropdown-item">View programs</a>
                                                            <a href="edit-earning-requirement.html" className="dropdown-item">Edit</a>
            ...
            {/* View competencies modal */}
            <div>
                <div className="modal fade" id="viewCompetencies" tabIndex={-1} aria-labelledby="viewCompetenciesLabel" aria-hidden="true">
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            <div className="modal-header modal-colored-header bg-primary">
                                <h4 className="modal-title" id="viewCompetenciesLabel">List of Competencies</h4>
                                ...
                                <table className="table table-centered table-striped align-middle">
                                    <tbody>
                                        <tr>
                                            <td>Competency 1</td>
                                            <td>
                                                <a href="edit-competency.html" className="btn btn-outline-primary btn-sm">Edit</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Competency 2</td>
...
export default EarningRequirements;

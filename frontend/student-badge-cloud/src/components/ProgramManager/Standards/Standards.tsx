                        ...
                        <div className="col-12">
                            <div className="page-title-box">
                                <div className="page-title-right">
                                    <Link to="/program/add-standard" className="btn btn-primary">Add Standard</Link>
                                </div>
                                <h4 className="page-title">Standard List</h4>
                            </div>
                        </div>
                    </div>
                    {/* end page title */}
                                                ...
                                                <td>
                                                    <div className="dropdown">
                                                        ...
                                                        <div className="dropdown-menu dropdown-menu-animated">
                                                            ...
                                                            <a href="edit-standard.html" className="dropdown-item">Edit</a>
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            <div className="modal-header modal-colored-header bg-primary">
                                ...
                                <button type="button" className="btn-close text-dark" data-bs-dismiss="modal" aria-hidden="true" />
                            </div>

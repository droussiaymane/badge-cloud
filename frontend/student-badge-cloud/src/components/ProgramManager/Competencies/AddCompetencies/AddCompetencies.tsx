                        ...
                        <div className="col-12">
                            <div className="page-title-box">
                                <div className="page-title-right">
                                    <Link to="/program/competencies" className="btn btn-primary">Go To Competency List</Link>
                                </div>
                                <h4 className="page-title">Add Competency</h4>
                            </div>
                        </div>
                    </div>
                    {/* end page title */}
                            ...
                            <div className="card">
                                <div className="card-body">
                                    <form className="needs-validation" noValidate>
                                        ...
                                        <button 
                                         onClick={handler}
                                        className="btn btn-primary me-2" type="submit">Submit</button>
                                        <Link to="/program/competencies" className="btn btn-outline-primary">Cancel</Link>
                                    </form>
                                </div> {/* end card-body*/}
                            </div> {/* end card*/}
                        </div> {/* end col*/}

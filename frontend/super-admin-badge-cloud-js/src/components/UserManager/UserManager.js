...
const UserList = () => {
    ...
    const editById = async (data) => {
        ...
        try {
            const res = await UserApi.edit(body);
            await dispatch(
    ...
    const getAndDeleteById = async () => {
        try {
            await UserApi.deleteById(deleteRecord);
                    ...
                    <div className='col-12'>
                        <div className='page-title-box'>
                            <div className='page-title-right'>
                                <span style={{ margin: '5px' }}><Link to='/user-manager/add-bulk-user' className='btn btn-primary'>
                                    Add Bulk User
                                </Link></span>
                                <span style={{ margin: '5px' }}><Link to='/user-manager/assign-bulk-program' className='btn btn-primary'>
                                    Assign Bulk Program
                                </Link></span>
                                <Link to='/user-manager/add-user' className='btn btn-primary'>
                                    Add User
                                </Link>
                            </div>
                                            ...
                                            >
                                                ...
                                                <tbody>
                                                    {records?.map((record, index) => {
                                                        ...
                                                        return (
                                                            <tr key={record?.id}>
                                                                <td>{record?.firstName ? capitalizeWords(record.firstName) : '' + " " + record?.surName ? capitalizeWords(record.surName) : ''}</td>
                                                                <td>{record?.userId}</td>
                                                                <td>{record?.userCategoryModel?.category}</td>
                                                                ...
                                                                <td>
                                                                    <div className='dropdown'>
                                                                        ...
                                                                        <div className='dropdown-menu dropdown-menu-animated'>
                                                                            ...
                                                                            <Link to="/user-manager/assign-program" class="dropdown-item" state={{ id: record?.id }}>Assign</Link>
                                                                            <Link
                                                                                to='/user-manager/edit-user'
                                                                                class='dropdown-item'
                                                                                state={{ id: record?.id }}
                                                                            >
                                                                                Edit

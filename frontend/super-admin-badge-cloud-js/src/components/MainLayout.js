        ...
        <div className="leftside-menu" style={{ paddingTop: 120 }}>
            ...
            <div className="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <ul className="side-nav">
                    ...
                    <li className="side-nav-item">
                        <a href="user/user-manager.html" className="side-nav-link">
                            <i className="uil-users-alt" />
                            <span> User Manager </span>
                        </a>
                    </li>
                    <li className="side-nav-item">
                        <a data-bs-toggle="collapse" href="#sidebarProgram" aria-expanded="false" aria-controls="sidebarProgram" className="side-nav-link">
                            <i className="uil-sitemap" />
                    ...
                    <li className="side-nav-item">
                        <a href="badge/badge-collection-list.html" className="side-nav-link">
                            <i className="uil-award" />
                            <span> Badge Template Manager </span>
                        </a>
                    </li>
                    <li className="side-nav-item">
                        <a data-bs-toggle="collapse" href="#sidebarTagManager" aria-expanded="false" aria-controls="sidebarTagManager" className="side-nav-link">
                    ...
                    <li className="side-nav-item">
                        <a href="attribute-manager/attribute-manager.html" className="side-nav-link">
                            <i className="uil-subject" />
                            <span> Attribute Manager </span>
                        </a>
                    </li>
                    <li className="side-nav-item">
                        <a href="curriculum-manager/curriculum-manager.html" className="side-nav-link">

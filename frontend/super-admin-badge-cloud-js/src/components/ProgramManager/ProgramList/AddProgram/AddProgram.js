    ...
    return (
        <Formik
            ...
            onSubmit={async (
                ...
                try {
                    setSubmitting(true);
                    const res = await ProgramApi.create(values, tenantId);
                    await dispatch(
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-6">
                                                        <div className="mb-3">
                                                            ...
                                                            />
                                                            <ErrorMessage name=' ' render={renderError} />
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-6">
                                                        <div className="mb-3">
                                                            ...
                                                            <Select
                                                                ...
                                                                onChange={(e) => {
                                                                    ...
                                                                    values.instructorsId = e.flatMap(item => item.value);
                                                                }}
                                                    ...
                                                    <div className="col-lg-6">
                                                        <div className="mb-3">
                                                            ...
                                                            <Select
                                                                ...
                                                                onChange={(e) => {
                                                                    SetStudentOption(e);
                                                                    values.studentsId = e.flatMap(item => item.value);
                                                                }}
                                                        ...
                                                        <div className="mb-3">
                                                            ...
                                                            <Select
                                                                ...
                                                                onChange={(e) => {
                                                                    ...
                                                                    values.competencies = e.flatMap(item => item.value);
                                                                }}

...
const EnableBulkCollection = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const res = await ProgramApi.enableBulkCollection(formData, tenantId);
            await dispatch(
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="page-title-box">
                                    ...
                                    <h4 className="page-title">Enable Bulk Collection</h4>
                                </div>
                            </div>
                        </div>
                        <div className="row">
...
export default EnableBulkCollection;

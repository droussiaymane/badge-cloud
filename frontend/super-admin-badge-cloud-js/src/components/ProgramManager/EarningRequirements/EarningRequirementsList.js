...
const EarningRequirementsList = () => {
  ...
  const getAllList = async () => {
    try {
      const response = await EarningRequirementsApi.getAll(tenantId, page, limit);
  ...
  const editById = async (data) => {
    ...
    try {
      const res = await EarningRequirementsApi.edit(body);
      await dispatch(
  ...
  const getAndDeleteById = async () => {
    try {
      await EarningRequirementsApi.deleteById(deleteRecord);
          ...
          <div className='col-12'>
            <div className='page-title-box'>
              <div className='page-title-right'>
                <Link
                  to='/program/add-earning-requirements'
                  className='btn btn-primary'
                >
                  Add Earning Requirement
                </Link>
              </div>
              <h4 className='page-title'>Add Earning Requirement List</h4>
            </div>
          </div>
        </div>
        <div className='row'>
                                ...
                                <td>
                                  <div className='dropdown'>
                                    ...
                                    <div className='dropdown-menu dropdown-menu-animated'>
                                      ...
                                      <Link
                                        to='/program/edit-earning-requirements'
                                        class='dropdown-item'
                                        state={{ id: record?.id }}
                                      >
                                        Edit
...
export default EarningRequirementsList;

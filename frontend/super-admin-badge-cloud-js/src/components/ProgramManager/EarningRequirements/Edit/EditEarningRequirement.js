...
const EditEarningRequirement = () => {
  ...
  const getStandardById = async (id) => {
    try {
      const response = await EarningRequirementsApi.getById(id);
      setRecords(response);
    } catch (error) {
    }
  }
    ...
    <Formik
      ...
      onSubmit={async (
        ...
        try {
          ...
          const res = await EarningRequirementsApi.create(submittingObject,tenantId);
          await dispatch(
          ...
          setSubmitting(false);
          resetForm();
          navigate('/program/earning-requirements');
        } catch (error) {
          await dispatch(
                  ...
                  <div className='col-12'>
                    <div className='page-title-box'>
                      <div className='page-title-right'>
                        <Link
                          to='/program/earning-requirements'
                          className='btn btn-primary'
                        >
                          Go To Earning Requirement List
                        </Link>
                      </div>
                      <h4 className='page-title'>Edit Earning Requirement</h4>
                    </div>
                  </div>
                </div>
                <div className='row'>
...
export default EditEarningRequirement;

...
const EditStandard = () => {
  ...
  const getStandardById = async (id) => {
    try {
      const response = await StandardsApi.getById(id);
      setRecords(response);
    } catch (error) {}
  };
    ...
    <Formik
      ...
      onSubmit={async (
        ...
        try {
          ...
          const res = await StandardsApi.create(submittingObject,tenantId);
          await dispatch(
                  ...
                  <div className='col-12'>
                    <div className='page-title-box'>
                      <div className='page-title-right'>
                        ...
                        >
                          Go To Standards List
                        </Link>
                      </div>
                      <h4 className='page-title'>Edit Standard</h4>
                    </div>
                  </div>
                </div>
                <div className='row'>

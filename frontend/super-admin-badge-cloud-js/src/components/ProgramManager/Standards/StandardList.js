...
const StandardsList = () => {
  ...
  const getAllList = async () => {
    try {
      const response = await StandardsApi.getAll(tenantId, page, limit);
  ...
  const editById = async (data) => {
    ...
    try {
      const res = await StandardsApi.edit(body);
      await dispatch(
  ...
  const getAndDeleteById = async () => {
    try {
      await StandardsApi.deleteById(deleteRecord);
          ...
          <div className='col-12'>
            <div className='page-title-box'>
              <div className='page-title-right'>
                <Link to='/program/add-standard' className='btn btn-primary'>
                  Add Standard
                </Link>
              </div>
              <h4 className='page-title'>Standards List</h4>
            </div>
          </div>
        </div>
        <div className='row'>
